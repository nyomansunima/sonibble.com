...
export const metadata: Metadata = {
  ...
  description:
    'Sonibble privacy policy. Know more about how we use your data and policy to use our platform',
  openGraph: {
    ...defaultOpenGraphMetadata,
    title: 'Privacy Policy | Sonibble',
    description:
  ...
  return (
    <main className="flex flex-col laptop:py-20 py-20">
      <div className="container mx-auto">
        <article className="text-foreground mx-auto px-5 prose prose-lg dark:prose-invert prose-headings:font-semibold prose-headings:font-heading dark:prose-headings:text-foreground laptop:prose-h1:text-6xl prose-h1:text-5xl prose-a:no-underline">
          ...
          <p>
            ...
            procedures followed by https://sonibble.com ("we," "us," or "our")
