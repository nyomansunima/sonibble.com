...
export const metadata: Metadata = {
  ...
  description: 'Sonibble term of use. Please read our terms of use.',
  openGraph: {
    ...defaultOpenGraphMetadata,
    title: 'Terms of use | Sonibble',
    description: 'Sonibble term of use. Please read our terms of use.',
  ...
  return (
    <main className="flex flex-col laptop:py-20 py-20">
      <div className="container mx-auto">
        <article className="mx-auto text-foreground px-5 prose prose-lg dark:prose-invert prose-headings:font-medium dark:prose-headings:text-foreground laptop:prose-h1:text-6xl prose-h1:text-5xl prose-a:no-underline prose-a:text-foreground">
          ...
          <p>
            ...
            website, located at{' '}
            <a href="https://sonibble.com">https://sonibble.com</a>. Please read
            these terms carefully before accessing or using our website.
          </p>
          ...
          <p>
            In no event shall
            <a href="https://sonibble.com">https://sonibble.com</a> or its
